...
/// <summary>Splits a sigma schedule at a denoise fraction (ComfyUI core) for custom-sampler img2img workflows.
/// Output 0 is the high-sigma head, output 1 the low-sigma tail the img2img runs.

...
public sealed class LtxV2I2VWorkflow : EditWorkflowBase
{
    ...
    private const string Ltx2Negative =
    ...
    public override Dictionary<string, object> Build(ParamValues p, ResolvedRequirements req, WorkflowInputs inputs)
    {
        ...
        wf["12"] = ComfyGraph.Node("CLIPTextEncode", new { text = Ltx2Negative, clip = clip0 });
        ...
        wf["55"] = ComfyGraph.Node("LTXVScheduler", new { steps = p.Int("steps", 8), max_shift = 2.05, base_shift = 0.95, stretch = true, terminal = 0.1, latent = ComfyGraph.Ref("53", 2) });

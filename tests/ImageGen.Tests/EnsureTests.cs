...
public sealed class EnsureTests
{
    ...
    public void NotNegative_allows_zero_but_refuses_negatives()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.NotNegative(-1));
    }
    ...
    public void AtLeast_enforces_the_floor()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.AtLeast(4, 5));
    }
    ...
    public void Between_double_refuses_outside_and_returns_inside()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.Between(5.1, 0.0, 5.0));
    }
    ...
    public void AtMost_enforces_the_ceiling()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.AtMost(6, 5));
    }
    ...
    public void LessThan_refuses_the_bound_itself()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.LessThan(5, 5));
    }
    ...
    public void Double_range_overloads_resolve_and_enforce()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.GreaterThanZero(0.0));
        Assert.Equal(0.0, Ensure.NotNegative(0.0));
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.NotNegative(-0.1));
    ...
    public void NotNull_returns_the_value_or_throws()
    {
        ...
        _ = Assert.Throws<ArgumentNullException>(() => Ensure.NotNull((string?)null));
    }
    ...
    public void NotNullOrEmpty_refuses_null_and_empty()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotNullOrEmpty(""));
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotNullOrEmpty(null));
    }
    ...
    public void NotNullOrWhiteSpace_refuses_whitespace()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotNullOrWhiteSpace("   "));
    }
    ...
    public void NotEmpty_refuses_an_empty_collection()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotEmpty(Array.Empty<int>()));
    }
    ...
    public void Equal_and_NotEqual_enforce_the_relation()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.Equal(3, 4));
        Assert.Equal(3, Ensure.NotEqual(3, 4));
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotEqual(3, 3));
    }
    ...
    public void OneOf_enforces_membership()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.OneOf(9, allowed));
    }
    ...
    public void Defined_refuses_an_undefined_enum_value()
    {
        ...
        _ = Assert.Throws<ArgumentOutOfRangeException>(() => Ensure.Defined((Sample)99));
    }
    ...
    public void NotDefault_refuses_the_default()
    {
        ...
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotDefault(0));
        _ = Assert.Throws<ArgumentException>(() => Ensure.NotDefault(Sample.A));
    }
